...
from app.utils.models import Attendance,User,Feedback,db,Lesson


student_feedback_blueprint=Blueprint('student_feedback',__name__)

@student_feedback_blueprint.route('/student/<int:id>/feedback',methods=['POST','GET'])
